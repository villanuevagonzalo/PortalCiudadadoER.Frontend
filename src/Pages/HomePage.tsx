      ...
      {isLogged?
        <div>
          ...
          <div className="flex space-x-4 justify-center w-full md:justify-start">
            <Link to="/Ingresar" className="bg-white text-gray-800 font-bold rounded-lg my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-110 duration-300 ease-in-out" onClick={Logout}>
            Cerrar Sesión
            </Link>
          </div>
        </div>
