import { FormElementInitialValues, FormElementBases, ElementPropsMap, FormElementProps } from "./Types";



export class FormElement<T extends keyof ElementPropsMap> {
  id: string;
  type: T;
  properties: ElementPropsMap[T];
  properties_required: string[];
  properties_optional: string[];

  constructor(type: T, properties: ElementPropsMap[T]) {
...
export class FormElementInstance<T extends keyof ElementPropsMap> extends FormElement<T> {
  value: any;

  constructor(type: T, properties: ElementPropsMap[T], value = '') {
...
export const GetJSONData = (elements: FormElement<keyof ElementPropsMap>[]) => {
